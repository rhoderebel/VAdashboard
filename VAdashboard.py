...
if sidebar_page == 'Statistische analyse':
    ...
    if radio_analyse == 'Regressie':
        ...
        st.sidebar.markdown("""<hr style="height:10px;width:260px;margin-right:-300px;border:none;color:rgb(187, 217, 117);background-color:rgb(187, 217, 117);" /> """, unsafe_allow_html=True)
