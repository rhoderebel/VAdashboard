...
def header(tekst):
     st.markdown(f'<b7 style="background-color:#e3f3be;color:#262730;text-size-adjust:100%;font-size:1rem;font-weight:normal;line-height:1.5;pointer-events:auto;box-sizing:border-box;margin-bottom:-1rem;">{tekst}</b7>', unsafe_allow_html=True)
